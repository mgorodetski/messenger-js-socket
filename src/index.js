...
socket.on("receiveMessage", response => {
    ...
    const messageIngo = document.createElement("div");
    messageIngo.classList.add("messageInfo");
    const userName = document.createElement("p");
    userName.innerText = socket.id;
    ...
    innerMessage.appendChild(messageIngo);
    messageIngo.appendChild(userName);
    messageIngo.appendChild(date);
